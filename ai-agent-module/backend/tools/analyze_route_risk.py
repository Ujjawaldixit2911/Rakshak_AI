...
Tool wrapper calling the Route Risk Analysis Module REST API (/api/risk/analyze-route).
"""
import os
import logging
...
async def analyze_route_risk(
    ...
    """
    Evaluates segment-by-segment crime risk for a route geometry via POST /api/risk/analyze-route.
    """
