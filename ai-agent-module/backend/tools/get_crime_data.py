"""
get_crime_data.py
Tool wrapper calling the Crime Data Module REST API (/api/crimes/nearby).
"""
import os
import logging
...
async def get_crime_data(
    ...
    """
    Fetches nearby crime incident records from GET /api/crimes/nearby.
    """
    ...
    try:
        ...
        if res.status_code == 200:
            ...
            return {
                ...
                "crimes": crimes[:10]  # Return top 10 for concise LLM context
            }
        else:
            return {
