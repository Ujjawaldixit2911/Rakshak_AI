  ...
  return (
    <>
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "1.5rem 1rem 4rem" }}>
        ...
        {/* ── Interactive AI Safety Presenter Hero Stage ──────────────────────── */}
        <HeroAvatarPresenter
          onExploreMap={() => {
            const mapEl = document.getElementById("safety-map-section");
            if (mapEl) {
              mapEl.scrollIntoView({ behavior: "smooth" });
            }
          }}
          onOpenCopilot={() => {
            const copilotBtn = document.getElementById("rakshak-copilot-launcher");
            if (copilotBtn) {
              copilotBtn.click();
            }
          }}
        ...
        <div id="safety-map-section" className="card" style={{ padding: "1.25rem", marginBottom: "1.5rem" }}>
