...
export default function GoogleAuthGateway() {
  ...
  const googleClientId =
    ...
    "406554765082-n19drc69ghvalq142uk3g6orfm9fk3lt.apps.googleusercontent.com";
  ...
  const handleGoogleCredentialResponse = (response: any) => {
    try {
      ...
      setSelectedAccount({
        ...
        avatar:
          payload.picture ||
          `https://api.dicebear.com/7.x/bottts/svg?seed=${encodeURIComponent(payload.email)}`,
      });
      setStep(2);
    } catch (e) {
              ...
              <div>
                ...
                <div style={{ marginBottom: "1.5rem" }}>
                  ...
                  <p style={{ fontSize: "0.82rem", color: "#94a3b8", margin: 0 }}>
                    Official Google OAuth 2.0 Client active.
                  </p>
                </div>

                {/* Google Official Identity Services Button Mount */}
                <div style={{ marginBottom: "1.25rem" }}>
                  <div ref={googleBtnContainerRef} style={{ display: "flex", justifyContent: "center", minHeight: "44px" }} />
